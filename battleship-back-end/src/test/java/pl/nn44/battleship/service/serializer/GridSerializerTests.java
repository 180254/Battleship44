...
public class GridSerializerTests {
  ...
  private GridSize gridSize(int rows, int cols) {
    return new GridSize(rows, cols);
  }

  @Test
  public void deserialize_proper() {
    GridSerializer gridSerializer = new GridSerializer(gridSize(2, 3));
  ...
  public void deserialize_empty() {
    GridSerializer gridSerializer = new GridSerializer(gridSize(0, 0));
  ...
  public void serializeAndDeserialize_matches() {
    GridSerializer gridSerializer = new GridSerializer(gridSize(2, 3));
    Grid grid = new Grid(gridSize(2, 3), new int[]{0, 1, 1, 0, 0, 0});
